...
export default function VPAADashboard() {
  ...
  const endorsed  = submissions.filter(s => ['pending_admin', 'validated', 'scheduled'].includes(s.status))
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <StatCard label="Endorsed"          value={String(endorsed.length)}         icon={CheckCircle}   color="green" />
